  ...
  return (
    <div className="page-pad" style={{padding:"28px 32px",background:"var(--bg)",minHeight:"100%"}}>
      <div className="fu" style={{marginBottom:24}}>
        <h1 style={{fontSize:24,fontWeight:900,color:"var(--text)",letterSpacing:"-.5px"}}>Viva Question Predictor</h1>
        <p style={{fontSize:13,color:"var(--muted)",marginTop:6}}>Upload your project code → get <span style={{color:"#fbbf24",fontWeight:700}}>20 AI-predicted</span> viva questions</p>
      </div>
      ...
      {!result ? (
        <div style={{maxWidth:580}}>
          ...
          <button onClick={generate} disabled={!file||loading}
            className="btn-glow"
            style={{width:"100%",padding:"14px",borderRadius:12,border:"none",cursor:"pointer",background:"linear-gradient(135deg,#fbbf24,#f97316)",color:"#fff",fontSize:15,fontWeight:700,opacity:!file||loading?.5:1,display:"flex",alignItems:"center",justifyContent:"center",gap:8,letterSpacing:".2px"}}>
        ...
        <div>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {filtered.map((q,i)=>(
              <div key={q.id} style={{animation:`fadeUp .35s ${i*0.03}s cubic-bezier(.22,1,.36,1) both`}}>
